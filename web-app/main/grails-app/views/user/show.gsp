	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="bornDate-label" class="property-label"><g:message code="user.bornDate.label" default="Born Date" /></span>
					
						<span class="property-value" aria-labelledby="bornDate-label"><g:formatDate date="${userInstance?.bornDate}" /></span>
