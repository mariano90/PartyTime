		...
		<div id="list-drink" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="preparation" title="${message(code: 'drink.preparation.label', default: 'Preparation')}" />
				...
				<g:each in="${drinkInstanceList}" status="i" var="drinkInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: drinkInstance, field: "preparation")}</td>
