			...
			<thead>
				...
				<g:each in="${barInstanceList}" status="i" var="barInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: barInstance, field: "street")}</td>
					
						<td>${fieldValue(bean: barInstance, field: "number")}</td>
					
						<td>${fieldValue(bean: barInstance, field: "floor")}</td>
					
						<td>${fieldValue(bean: barInstance, field: "apartment")}</td>
