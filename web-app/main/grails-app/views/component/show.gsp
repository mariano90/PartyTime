		...
		<div id="show-component" class="content scaffold-show" role="main">
			...
			<ol class="property-list component">
				...
				<li class="fieldcontain">
					<span id="ingredient-label" class="property-label"><g:message code="component.ingredient.label" default="Ingredient" /></span>
					
						<span class="property-value" aria-labelledby="ingredient-label"><g:link controller="ingredient" action="show" id="${componentInstance?.ingredient?.id}">${componentInstance?.ingredient?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="amount-label" class="property-label"><g:message code="component.amount.label" default="Amount" /></span>
					
						<span class="property-value" aria-labelledby="amount-label"><g:fieldValue bean="${componentInstance}" field="amount"/></span>
