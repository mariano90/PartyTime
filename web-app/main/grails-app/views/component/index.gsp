		...
		<div id="list-component" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="component.ingredient.label" default="Ingredient" /></th>
					
						<g:sortableColumn property="amount" title="${message(code: 'component.amount.label', default: 'Amount')}" />
				...
				<g:each in="${componentInstanceList}" status="i" var="componentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${componentInstance.id}">${fieldValue(bean: componentInstance, field: "ingredient")}</g:link></td>
					
						<td>${fieldValue(bean: componentInstance, field: "amount")}</td>
