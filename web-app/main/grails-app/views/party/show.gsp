		...
		<div id="show-party" class="content scaffold-show" role="main">
			...
			<ol class="property-list party">
				...
				<li class="fieldcontain">
					<span id="host-label" class="property-label"><g:message code="party.host.label" default="Host" /></span>
					
						<span class="property-value" aria-labelledby="host-label"><g:link controller="user" action="show" id="${partyInstance?.host?.id}">${partyInstance?.host?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="place-label" class="property-label"><g:message code="party.place.label" default="Place" /></span>
					
						<span class="property-value" aria-labelledby="place-label"><g:link controller="place" action="show" id="${partyInstance?.place?.id}">${partyInstance?.place?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="startDateTime-label" class="property-label"><g:message code="party.startDateTime.label" default="Start Date Time" /></span>
					
						<span class="property-value" aria-labelledby="startDateTime-label"><g:formatDate date="${partyInstance?.startDateTime}" /></span>
				...
				<li class="fieldcontain">
					<span id="guests-label" class="property-label"><g:message code="party.guests.label" default="Guests" /></span>
