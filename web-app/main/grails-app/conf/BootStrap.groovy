...
class BootStrap {
	...
	def init = { servletContext ->
		...
		Component fernetAl20 = new Component(ingredient: botellaFernet, amount: "al 20%").save(failOnError: true)
		Component ganciaAl50 = new Component(ingredient: botellaGancia, amount: "al 50%").save(failOnError: true)
		Component cocaAl80 = new Component(ingredient: botellaCoca, amount: "al 80%").save(failOnError: true)
		Component spriteAl50 = new Component(ingredient: botellaSprite, amount: "al 50%").save(failOnError: true)
		Component cervezaAl100 = new Component(ingredient: botellaCerveza, amount: "todo el vaso").save(failOnError: true)
		Component vodkaAl50 = new Component(ingredient: botellaVodka, amount: "al 50%").save(failOnError: true)
		Component energizanteAl30 = new Component(ingredient: lataEnergizante, amount: "al 30%").save(failOnError: true)
		Component energizanteAl50 = new Component(ingredient: lataEnergizante, amount: "al 50%").save(failOnError: true)
		Component jugoAl20 = new Component(ingredient: botellaJugo, amount: "al 20%").save(failOnError: true)
		Component champagneAl70 = new Component(ingredient: botellaChampagne, amount: "al 70%").save(failOnError: true)
